...
import LicenciaUsuario from './LicenciaUsuario';
...
function VerUsuario() {
    ...
    return (
        ...
        <Col lg={24} >
            <Card> 
                <Row>
                <Col style={{paddingLeft: 10}} lg={24}><h1 style={{fontSize: 20}}>Información del usuario</h1></Col>
            ...
            <Card> 
                <Row>
                    <Col style={{padding: 10}} lg={24}>
                        <Spin spinning={loading}>
                        <h3 style={{marginBottom: 15}}><CarOutlined/> Autos asignados</h3>
                        ...
                        {!loading && <AutosAsignados usr_rut={usr_rut}/>}
                        </Spin>
                    </Col>   
                </Row>
            </Card>
